   ...
   var listingData
    ...
    fs.readFile('listings.json', 'utf8', (err, data)=>{
      try {
          ...
          listingData.forEach((location)=>{
            const newListing = Listing.create({
              code: location.code,
              name: location.name,
              latitude: location.coordinates ? location.coordinates.latitude : null,
              longitude: location.coordinates ? location.coordinates.longitude : null,
